...
export function KanbanColumn({ column, tasks, allColumns, onAddTask }: ColumnProps) {
  ...
  return (
    <div
      className="flex flex-col flex-shrink-0 w-[300px] max-h-full h-full rounded-2xl shadow-xl overflow-hidden backdrop-blur-md border transition-colors duration-300"
      style={{
